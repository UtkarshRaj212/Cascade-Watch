...
import { ALL_INVENTORY_SEEDS } from "../lib/db/mock-inventories";
...
async function seed() {
  ...
  // Facility Inventories for all facilities and drugs (52 records covering all 13 hospitals x 4 medicines)
  const inventoryList = ALL_INVENTORY_SEEDS;
