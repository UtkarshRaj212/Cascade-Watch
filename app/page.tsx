...
import { Activity, ArrowRight, Waves, ShieldAlert, TrendingDown, ArrowRightLeft, ClipboardList } from "lucide-react";
    ...
    <main className="flex-1 max-w-[1750px] w-full mx-auto px-3 sm:px-5 py-2 lg:py-2.5 flex flex-col lg:h-[calc(100vh-58px)] lg:max-h-[calc(100vh-58px)] lg:overflow-hidden min-h-0">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-3 lg:gap-3.5 items-stretch flex-1 min-h-0">
        ...
        <div className="lg:col-span-5 xl:col-span-4 flex flex-col h-full min-h-0 justify-between gap-2">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 pt-1.5 border-t border-[#1c1c1c] shrink-0">
            <Link
              href="/cascade"
            ...
            <Link
              ...
              className="py-1.5 px-2 rounded-lg bg-[#0a0a0a] hover:bg-[#141414] border border-[#222222] hover:border-[#383838] transition-all flex items-center justify-center gap-1.5 text-center group"
            >
              <ArrowRightLeft className="w-3.5 h-3.5 text-emerald-400 group-hover:scale-110 transition-transform shrink-0" />
              <span className="text-[11px] font-mono font-medium text-neutral-300 group-hover:text-white truncate">
                Redistribute
              </span>
            </Link>
            ...
            <Link
              href="/inventory"
              className="col-span-2 sm:col-span-4 py-2 px-3 rounded-lg bg-amber-950/40 hover:bg-amber-950/60 border border-amber-800/60 hover:border-amber-600/80 transition-all flex items-center justify-center gap-1.5 text-center group"
            >
              <ClipboardList className="w-3.5 h-3.5 text-amber-400 group-hover:scale-110 transition-transform shrink-0" />
              <span className="text-[11px] font-mono font-medium text-amber-100 group-hover:text-white truncate">
                Stock Advisor
              </span>
            </Link>
          </div>
