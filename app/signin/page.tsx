...
export default function SignInPage() {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white flex flex-col justify-center items-center px-4 py-12 relative overflow-hidden">
      ...
      <div className="absolute bottom-1/4 -right-32 w-96 h-96 bg-rose-950/20 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-lg font-bold font-mono text-white tracking-wide">
            Clinical Supply Network Access
          </h1>
          <p className="text-xs text-neutral-400 font-mono mt-1">
            Sign in to access facility inventories, cascade risk engine & telemetry.
          </p>
        </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="health.officer@mediripple.gov"
        ...
        <div className="flex items-center justify-center gap-2 mt-6 text-[11px] font-mono text-neutral-400">
          ...
          <span>Encrypted Session Telemetry &bull; Better Auth Protected</span>
        </div>
      </div>
    </div>
  );
